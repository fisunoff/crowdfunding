...
declare global {
  ...
  import('vue')
  // @ts-ignore
  export type { AuthResponse, UserLogin, ProfileReadData, ProfileCreateData, ValidationError, HTTPValidationError, BaseProjectData, GlobalStatsData, ProjectStatus, CreatedProjectData } from './api/types'
  import('./api/types')
}
