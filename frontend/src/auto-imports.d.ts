...
export {}
declare global {
  const API_BASE: typeof import('./api/http').API_BASE
  const BASE_URL: typeof import('./api/api').BASE_URL
  const EffectScope: typeof import('vue').EffectScope
  const acceptHMRUpdate: typeof import('pinia').acceptHMRUpdate
  const api: typeof import('./api/api').default
  const apiAuthLogin: typeof import('./api/auth').apiAuthLogin
  const apiAuthRefresh: typeof import('./api/auth').apiAuthRefresh
  const apiAuthRegister: typeof import('./api/auth').apiAuthRegister
  const apiProfileMe: typeof import('./api/profile').apiProfileMe
  ...
  const getLocalAccessToken: typeof import('./api/tokenService').getLocalAccessToken
  const getLocalRefreshToken: typeof import('./api/tokenService').getLocalRefreshToken
  const h: typeof import('vue').h
  const http: typeof import('./api/http').http
  const inject: typeof import('vue').inject
  const instance: typeof import('./api/instance').default
  ...
  const removeTokens: typeof import('./api/tokenService').removeTokens
  const resolveComponent: typeof import('vue').resolveComponent
  const setActivePinia: typeof import('pinia').setActivePinia
  const setMapStoreSuffix: typeof import('pinia').setMapStoreSuffix
  const setTokens: typeof import('./api/tokenService').setTokens
...
declare global {
  ...
  import('vue')
  // @ts-ignore
  export type { AuthResponse, UserLogin, ProfileReadData, ProfileCreateData, ValidationError, HTTPValidationError, BaseProjectData, ProjectStatus, CreatedProjectData, BaseRewardData, RewardData, ContribSchema, DetailedContribSchema, GlobalStatsData, BaseProfileData } from './api/types'
  import('./api/types')
}
...
declare module 'vue' {
  ...
  interface ComponentCustomProperties {
    ...
    readonly instance: UnwrapRef<typeof import('./api/instance')['default']>
